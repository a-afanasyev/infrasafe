...
description: "Промышленная автоматизация (SCADA/DCS/PLC), архитектура IoT-систем, интеграция датчиков (4-20 мА, HART, Modbus), управление процессами, вопросы по АСУТП/ICS. Проектирование распределённых IoT-систем, диагностика токовых петель, подбор КИП, выбор протоколов связи."
