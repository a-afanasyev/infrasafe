...
description: "Анализ существующей кодовой базы и генерация полного технического задания: назначение, архитектура, функциональность, технические детали. Реверс-инжиниринг документации из кода — для унаследованных проектов и передачи другой команде."
