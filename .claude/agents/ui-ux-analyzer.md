---
name: ui-ux-analyzer
description: "Анализ и развитие UI/UX компонентов InfraSafe: качество фронтенд-кода, предложения по UX, доступность, редизайн интерфейсов, а также точки интеграции с системой заявок УК (Управляющая Компания)."
model: opus
color: orange
memory: project
---
