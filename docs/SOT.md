...
**Зависимости (production):** bcrypt, cors, dompurify, express, helmet, jsonwebtoken, pg, swagger-jsdoc, swagger-ui-express, winston, axios, express-validator, express-rate-limit, express-slow-down, uuid
...
|-----|-------------------|-------|-------------|
| Unit | 98 | ~1700+ | `tests/jest/unit/` |
| Integration | 2 | ~100+ | `tests/jest/integration/` |
| Security | 3 | ~100+ | `tests/jest/security/` |
| E2E | 13 | ~57 | `tests/jest/e2e/` |
| **Итого Jest** | **116** | **1955** | |
