...
```js
// Full route-level test setup — verifyWebhook bypassed (HMAC tested in webhookRoutes.test.js)
// This block goes at the TOP of the describe, after existing test setup.
...
routeApp.use('/webhooks/uk', webhookRoutes);
