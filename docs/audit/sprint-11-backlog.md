...
3. **Edge/infra (Phase E):** ~~SEC-19 (#100), SEC-20 (#101), SEC-21 (#102) + SEC-34 f/g~~ **✅ DONE + DEPLOYED 2026-06-07** (3 последовательных PR, каждый merge→deploy→verify; UK подтвердил SEC-19). Остаётся **SEC-22** (narrow `/uk/api/*`) — нужна UK-координация по фактическому списку путей.
