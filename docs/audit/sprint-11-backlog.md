...
**PR-2 + PR-2b + B-009 задеплоены на оба прода 2026-07-25.** Актуальный прод — **`4fd2a37`** (merge #150,
B-009); в тот же день до него прошли `6c88ae3` (PR-2) и `beaaba0` (PR-2b). Проверено на profk и
