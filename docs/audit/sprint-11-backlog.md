...
**Verified end-to-end в проде**: 4 telemetry сэмпла (id=6,7,8,9) от controller_id=1 → alert_id=25 LEAK_DETECTED CRITICAL → outbox → УК → ticket `260524-005` за 5 секунд от telemetry до УК.
